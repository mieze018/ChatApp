...
export const Button = styled.button(({ variant = 'primary', size = 'medium' }: ButtonProps) => [
  ...
  tw`inline-block font-medium leading-none border border-transparent rounded-md shadow-sm cursor-pointer hover:shadow focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary `,
])
