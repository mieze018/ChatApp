...
import type { authUserDisplayableType, chatType } from '@/src/types/firebaseDB'
...
import { timestampToReadableDate, timestampToRelativeDate } from '@/src/libs/timestampFormatter'
...
export const ChatMessage: React.FC<{
  ...
  photoURL: authUserDisplayableType['photoURL']
  displayName: authUserDisplayableType['photoURL']
...
const ChatMessageCreatedAt: React.FC<{
  ...
  return (
    <WrapperChatMessageCreatedAt title={timestampToReadableDate(createdAt)}>
      {relativeTime}
    </WrapperChatMessageCreatedAt>
  )
}
